...
def start(update, context):
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''🔥The Super Powered Monster Torrenz V2.1 is online now 😈 | You can use me for any task 💚.
        
🔻For Now my Maximum DL Speed is 70 MB/s
🔻For Now my Maximum UL Speed is 70 MB/s
